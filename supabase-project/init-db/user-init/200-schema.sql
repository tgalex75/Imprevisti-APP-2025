...
--
-- Name: bonus-annuali; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."bonus-annuali" (
...
--
-- Name: bonus-annuali_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: imprevisti; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.imprevisti (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    titolo text,
...
--
-- Name: registroimprevisti; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.registroimprevisti (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    title text NOT NULL,
    quantity smallint,
    user_id uuid DEFAULT auth.uid()
...
--
-- Name: registroo; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.registroo (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name text NOT NULL,
    description text,
    tipo text,
...
--
-- Name: saldo-punti; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."saldo-punti" (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    punti real NOT NULL,
    user_id uuid DEFAULT auth.uid()
);
...
--
-- Name: salvaxdopo; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.salvaxdopo (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    titolo text,
    descrizione text NOT NULL,
    user_id uuid DEFAULT auth.uid()
...
--
-- Name: imprevisti imprevisti_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: registroimprevisti registroimprevisti_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: registroo registroo_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: saldo-punti saldo-punti_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: salvaxdopo salvaxdopo_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bonus-annuali Enable delete for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: imprevisti Enable delete for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registroimprevisti Enable delete for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registroo Enable delete for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: salvaxdopo Enable delete for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: salvaxdopo Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bonus-annuali Enable insert for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: imprevisti Enable insert for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registroimprevisti Enable insert for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registroo Enable insert for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: imprevisti Enable update for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registroimprevisti Enable update for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: saldo-punti Enable update for users based on user_id; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bonus-annuali Enable users to view their own data only; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: imprevisti Enable users to view their own data only; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registroimprevisti Enable users to view their own data only; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: registroo Enable users to view their own data only; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: saldo-punti Enable users to view their own data only; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: salvaxdopo Select for auth only; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bonus-annuali; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public."bonus-annuali" ENABLE ROW LEVEL SECURITY;

--
-- Name: imprevisti; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.imprevisti ENABLE ROW LEVEL SECURITY;

--
-- Name: registroimprevisti; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.registroimprevisti ENABLE ROW LEVEL SECURITY;

--
-- Name: registroo; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.registroo ENABLE ROW LEVEL SECURITY;

--
-- Name: saldo-punti; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public."saldo-punti" ENABLE ROW LEVEL SECURITY;

--
-- Name: salvaxdopo; Type: ROW SECURITY; Schema: public; Owner: -
--
