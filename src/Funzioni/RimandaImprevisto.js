  ...
  return (
    <section className="xl:h-1/6 h-1/3 flex flex-col items-center gap-4">
      <button
        ...
        className="peer rounded-full p-2 text-center text-sm font-bold shadow-md transition duration-200 ease-in hover:scale-125 hover:[rgb(var(--clr-btn))] hover:text-[rgb(var(--clr-txt))]"
      >
