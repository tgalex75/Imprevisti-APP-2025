  ...
  return (
    <section className="flex h-full w-full flex-col items-center justify-center gap-4 p-4 font-bold">
      ...
      <motion.div
        ...
        className="flex h-full w-full flex-col items-center gap-2 overflow-y-auto rounded-lg bg-black/50 p-2 text-gray-300"
      >
        ...
        <ul className="flex h-fit w-full flex-col gap-1 px-2 pb-2">
          {speciali?.map((el) => (
            <li
              key={el.id}
              className="flex h-auto w-full items-center justify-evenly bg-gray-700/20 py-1 ps-2 text-left text-sm font-normal uppercase"
            >
