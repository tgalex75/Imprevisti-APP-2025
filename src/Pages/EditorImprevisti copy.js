  ...
  return (
    <section className="flex h-full w-full flex-col items-center gap-4 p-2 font-bold">
      ...
      <motion.div
        ...
        className="flex h-full w-full items-center justify-around overflow-hidden rounded-lg bg-black/50 px-2 text-[--clr-txt] md:flex-col"
      >
        ...
        <div className="relative flex min-h-[60vh] xl:min-h-[40dvh] w-full flex-col items-center justify-center gap-2 p-1">
          ...
          <ul className="flex h-full w-full flex-col gap-1 overflow-y-auto rounded-lg border p-1 xl:p-4">
            {data?.map((el) => (
              <li
                key={el.id}
                className="flex select-all items-center justify-between gap-2 bg-[--clr-txt]/20 ps-2 text-left text-sm font-normal hover:bg-[--clr-txt]/50"
              >
                <input
                  className="w-[25%] xl:w-[15%] select-all rounded border border-[--clr-txt]/20 bg-transparent p-1 pe-6 font-medium uppercase"
                ...
                />
                <input
                  className="w-[65%] xl:w-[75%] rounded border border-[--clr-txt]/20 bg-transparent p-1 pe-6 font-medium"
                ...
                <select
                  name="ultEstr"
                  id="ultEstr"
                  className="w-[5%] rounded border border-[--clr-txt]/20 bg-transparent p-1 pe-6 font-medium"
                  ref={(element) =>
                ...
                <select
                  name="qtGioc"
                  id="qtGioc"
                  className="w-[5%] select-all rounded border border-[--clr-txt]/20 bg-transparent p-1 text-center font-medium uppercase"
                ...
                <select
                  name="ultEstr"
                  id="ultEstr"
                  className="w-[5%] rounded border border-[--clr-txt]/20 bg-transparent p-1 text-center font-medium"
                  ref={(element) =>
                ...
                <MdSend
                  size={24}
                  className="cursor-pointer fill-[--clr-txt] transition-all hover:scale-125 hover:fill-[--clr-ter]"
                  onClick={() =>
                    updateVociRegistro(
                      el.id,
          ...
          <div className="flex h-1/3 w-full items-start justify-between gap-2 px-2">
            ...
            >
              ...
              <input
                ...
                type="radio"
                value={true}
                className="ms-2 h-4 w-4 rounded border-[--clr-txt] border-[--clr-txt] text-purple-600 focus:ring-2 focus:ring-purple-500 md:m-0 dark:border-[--clr-txt] dark:bg-[--clr-txt] dark:ring-offset-[--clr-txt] dark:focus:ring-purple-600"
              />
