  ...
  return (
    <section className="flex h-dvh w-full select-none flex-col items-center justify-start gap-2 px-4 py-6 font-bold xl:justify-around md:p-8">
      ...
      <motion.div
        ...
        className="flex h-full w-full select-none flex-col items-center justify-around gap-4 rounded-xl bg-black/30 px-4 py-2 text-center shadow-lg ring ring-inset ring-[--clr-txt] md:justify-evenly md:gap-2 md:px-10"
      >
        <SecondaEstrazione />
</motion.div>
    </section>
