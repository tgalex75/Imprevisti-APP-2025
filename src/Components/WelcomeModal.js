...
const WelcomeModal = () => {
  ...
  return (
    isModalOpen && (
      <>
        <motion.div
          className="fixed left-1/2 top-1/2 z-[1001] flex h-4/5 w-4/5 -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center gap-6 rounded-xl border-8 border-[--clr-btn] bg-[--clr-bg]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <button
            className="absolute left-1/2 bottom-5 -translate-x-1/2 uppercase w-3/4 md:w-1/3 rounded-lg bg-[--clr-btn] px-4 py-2 text-sm md:text-xl font-semibold"
